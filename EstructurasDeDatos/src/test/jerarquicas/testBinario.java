 ...
 *
 * @author Santiago B. 
 * IMPORTANTE SUBIR A GITHUB
 * Nota: AGREGAR METODO ISOMORFO Y BALANCEADO
 */

import Estructuras_Jerarquicas.ArbolBin;
...
public class testBinario {
    ...
    public static void main(String args[]) {
        ...
        System.out.println("Listar por niveles vacio: " + toStringLinkedList(a.listarPorNiveles()));
        ...
        System.out.println(a.sonIsomorfos(b));
